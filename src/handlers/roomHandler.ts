...
import IRoomParams from "../interfaces/IRoomsParams";
...
const roomHandler = (socket: Socket) => {
    ...
    const createRoom = () => {
        // this will be our unique room id in
        // which multiple connection will exchange data
        const roomId = UUIDv4();
    ...
    // We will call the above two function when the
    // client will emit events top create room and join room
